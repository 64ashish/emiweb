...
//            $result = MormonShipPassengerRecord::search($inputQuery);
//            $records = $result->paginate(100);
//        }
//
////      filter the thing and get the results ready
//        if($request->action === "filter"){
//            $melieRaw = MormonShipPassengerRecord::search($inputQuery,
...
//            $result = MormonShipPassengerRecord::whereIn('id', $idFromResults);
...
//        return view
        return view('dashboard.MormonShipPassengerRecord.records', compact('records', 'keywords', 'filterAttributes', 'advancedFields', 'defaultColumns','populated_fields','archive_name'))->with($request->all());
    }
}
