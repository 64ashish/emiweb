...
//        return view
        return view('dashboard.SwedishImmigrationStatisticsRecord.records', compact('records', 'keywords', 'filterAttributes', 'advancedFields', 'defaultColumns','populated_fields','archive_name'))->with($request->all());
    }
}
