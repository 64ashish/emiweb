...
//            $result = SwedishImmigrationStatisticsRecord::search($inputQuery);
//            $records = $result->paginate(100);
//        }
//
////      filter the thing and get the results ready
//        if($request->action === "filter"){
//            $melieRaw = SwedishImmigrationStatisticsRecord::search($inputQuery,
...
//            $result = SwedishImmigrationStatisticsRecord::whereIn('id', $idFromResults);
...
//        return view
        return view('dashboard.SwedishImmigrationStatisticsRecord.records', compact('records', 'keywords', 'filterAttributes', 'advancedFields', 'defaultColumns','populated_fields','archive_name','fieldsToDisply'))->with($request->all());
    }
}
