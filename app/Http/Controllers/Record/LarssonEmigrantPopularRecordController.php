...
//        prepare for search
        ...
        $records = LarssonEmigrantPopularRecord::search($inputQuery,
...
//        return view
        return view('dashboard.LarssonEmigrantPopularRecord.records', compact('records', 'keywords', 'filterAttributes', 'advancedFields', 'defaultColumns','populated_fields'))->with($request->all());
    }
}
