...
//        return view
        return view('dashboard.VarmlandskaNewspaperNoticeRecord.records', compact('records', 'keywords', 'filterAttributes', 'advancedFields', 'defaultColumns','populated_fields'))->with($request->all());
    }
}
