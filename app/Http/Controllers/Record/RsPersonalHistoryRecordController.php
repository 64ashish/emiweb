...
class RsPersonalHistoryRecordController extends Controller
{
    ...
    public function search( Request $request ){
        ...
        return view('dashboard.rsphistory.photos', compact('records', 'keywords', 'filterAttributes', 'enableQueryMatch','advancedFields', 'defaultColumns','populated_fields','archive_name','fieldsToDisply','toBeHighlighted','provincesCoun'))->with($request->all());
