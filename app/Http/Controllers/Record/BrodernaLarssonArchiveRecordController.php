...
//        prepare for search
        ...
        $records = BrodernaLarssonArchiveRecord::search($inputQuery,
...
//        return view
        return view('dashboard.larsson.records', compact('records',  'keywords','filterAttributes'))->with($request->all());
    }
