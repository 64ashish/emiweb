...
class SwedishAmericanJubileeRecord extends Model
{
    ...
    public function fieldsToDisply()
    {
        return [
            ...
            "emi_web_lan"=>__(ucfirst(str_replace('_', ' ', "emiweb_lan"))),
            "emi_web_forsamling"=>__(ucfirst(str_replace('_', ' ', "emiweb_forsamling"))),
            "emi_web_emigration_year"=>__(ucfirst(str_replace('_', ' ', "emiweb_emigration_year"))),
            "emi_web_akt_nr"=>__(ucfirst(str_replace('_', ' ', "emiweb_akt_nr"))),
