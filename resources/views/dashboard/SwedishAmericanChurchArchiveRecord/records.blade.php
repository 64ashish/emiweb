    ...
    <div class="grid grid-cols-1 gap-4 items-start lg:gap-8">
        ...
        <section class="pt-6" aria-labelledby="section-1-title">
            <div class="bg-white py-6 pl-4 pr-3 border-gray-300 shadow md:rounded-lg">
                ...
                @if(isset($keywords))
                {!! Form::model($keywords,['route' => 'sacar.search']) !!}
                @endif
                @if(!isset($keywords))
                {!! Form::open(['route' => 'sacar.search']) !!}
                @endif
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <tr>
                                        ...
                                        font-medium text-gray-900 sm:pl-6 lg:pl-8">
                                            {{ $record->first_name }} {{ $record->last_name1 }}
                                            {{ $record->last_name2 }}</td>
                                        ...
                                        <td class="whitespace-nowrap border-b border-gray-200 px-3 py-4 text-sm
                                        text-gray-500">
                                            {{  $record->immigrated_to_place }}
                                            {{  $record->immigrated_to_state }}
                                        </td>
                                        <td
