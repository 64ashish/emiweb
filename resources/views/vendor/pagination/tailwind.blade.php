@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between gap-x-5">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between gap-x-5">
            <div>
