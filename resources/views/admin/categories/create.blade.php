<x-admin-layout>
    ...
    <form class="space-y-8 divide-y divide-gray-200" method="POST" action="{{ route('admin.categories.store') }}">
        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                ...
                <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div class="space-y-6 sm:space-y-5">
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            <label for="first-name" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">{{ __('Category name') }} </label>
            ...
            <div class="pt-5">
                <div class="flex justify-end">
                    <a href="{{ route('admin.categories.index') }}" type="button" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">{{ __('Cancel') }}</a>
