    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div>
            ...
            <div class="mt-4 sm:flex sm:items-center">
                ...
                <a href="@role('super admin') {{ route('admin.statistics.index') }} @endrole @hasanyrole('emiweb admin|emiweb staff') {{ route('emiweb.statistics.index') }} @endhasanyrole" class="mt-3 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Clear</a>
            </div>
