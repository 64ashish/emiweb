    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <a href="{{ route('organizations.create') }}" class="inline-flex items-center justify-center rounded-md border
                            ...
                            @foreach($organizations as $organization)
                                <tr>
                                    ...
                                    text-right text-sm font-medium sm:pr-6 lg:pr-8">
                                        <a href="{{ route('organizations.edit', $organization) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
