<x-guest-layout>
        ...
        <div>
            ...
            <h3 class="text-2xl lg:text-2xl text-gray-900 font-bold mb-3">{{ __('Reset your password') }}</h3>
        </div>
    ...
    <form class="mt-8 space-y-6" action="/reset-password" method="POST">
        ...
        <div>
            ...
            <input id="password_confirmation " name="password_confirmation"  type="password"
                   required class="appearance-none rounded-none relative block w-full px-3 py-2 border
                       border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none
                       ßßfocus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="{{ __('Confirm Password') }}">
        </div>
