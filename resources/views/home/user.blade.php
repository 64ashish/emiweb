    ...
    <div class="grid grid-cols-2 gap-x-5">
                ...
                <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    <div class="px-4 py-3 text-right sm:px-6">
                        <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent
                             ...
                             focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update
                            Password</button>
                    </div>
                    {!! Form::close() !!}
                </dl>
        ...
        <div class="col-span-2 lg:col-span-1 bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="px-4 sm:px-6">
                <div class="text-gray-900 font-medium py-4">
                ...
                <form action="/subscribe" method="post" id="payment-form" data-secret="{{ $intent->client_secret }}">
                    ...
                    <div class="form-row">
                        <div class="flex items-center space-x-6 pr-8">
                            <label for="cardholder-name" class="flex-none w-1/3 text-gray-500 font-medium">Cardholder's
                                Name</label>
                        ...
                        <div x-data="{selectedPrice: 0}" class="md:flex md:justify-center md:space-x-6 my-8">
                            <div x-on:click="selectedPrice = 0 "
                                ...
                                <div>
                                    ...
                                    <label for="standard">
                                        <h4 class="font-medium text-gray-700">Standard</h4>
                                        <div class="font-bold text-gray-900 mb-6">
                            ...
                            <div x-on:click="selectedPrice = 1 "
                                ...
                                <div>
                                    ...
                                    <label for="premium">
                                        <h4 class="font-medium text-gray-700">Premium</h4>
