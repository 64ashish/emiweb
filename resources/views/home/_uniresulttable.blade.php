...
@switch($key)
    ...
    @case( $key == 'Svenskamerikanska kyrkoarkivet')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/sacar/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_parish={{ $keywords['parish'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'New Yorks passagerarlistor')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/nypr/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_year={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Emigranter registrerade i svenska kyrkböcker')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/scerc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_parish={{ $keywords['parish'] }}&dob={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Immigranter registrerade i svenska kyrkböcker')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/sisrc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_parish={{ $keywords['parish'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'SCB Emigranter')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/sesrc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&from_parish={{ $keywords['parish'] }}&birth_year={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Svenskamerikanska föreningsmedlemmar')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/samrc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_parish={{ $keywords['parish'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Svenskar i Alaska')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/siarc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Tidningsnotiser från Värmländska tidningar')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/vnnrc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_year={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Dalslänningar födda i Amerika')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/dbir/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Emigranter i norska kyrkböcker')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/nerc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&birth_date={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
    ...
    @case( $key == 'Den åländska emigrantdatabasen')
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
                                                                                ...
                                                                                font-medium  sm:pl-6 lg:pl-8">
        <a class="block" href="/ierc/search?first_name={{$keywords['first_name']}}&last_name={{ $keywords['last_name'] }}&date_of_birth={{ $keywords['year'] }}&action=search">
            {{ $key }}
        </a>
        </td>
        <td class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm
